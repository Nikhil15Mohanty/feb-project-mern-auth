...
export default function SignUp() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto' >
      ...
      <button disabled={loading}className='bg-slate-700 p-3 rounded-lg uppercase text-white 
      font-semibold hover:opacity-90'>{loading ? 'loading':'Sign Up'}</button>
      </form>
      ...
      <p className='text-red-600 mt-4 font-medium'>{error ? 'Something went wrong...': ''}</p>
    </div>
  )
}
